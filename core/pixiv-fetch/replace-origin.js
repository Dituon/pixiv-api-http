...
export let imageServerOrigin = 'http://' + config.proxy.imageHost[0]

/**
 * @param {string} url 
 * @return {string}
 */
export default !useOriginIP ?
    url => url :
    url => url.replace('https://i.pximg.net', imageServerOrigin)
